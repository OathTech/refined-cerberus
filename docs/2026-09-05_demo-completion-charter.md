...
|---|---|---|
| M1 — finish E5 | t6_switch and t4_while public proofs and production results; assignment protocol and whole-term membership; range review from `8eeaf92` through the completed E5 candidate, including supply normalization. | t5 and t6 execution complete; t6 full gate green ([record](../cerberus-heaplang/docs/2026-09-05_e5-t6-notes.md)). t4 has whole-term membership, checked continuations and public total proofs of its condition, assignments and body through the back edge ([latest record](../cerberus-heaplang/docs/2026-09-06_e5-t4-body.md)). Its decreasing loop invariant, exit/return proof, production result and E5 review remain open. |
