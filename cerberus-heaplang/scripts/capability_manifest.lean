...
def variants : List Variant := [
  ...
  { ctor := `CerberusHeapLang.Frag.unseq,
    ...
    also := [N "wpt_jump_frame_unseq", N "wpt_unseq_pure_right", N "wpt_unseq_pure_left",
      N "EmittedIntSupport.wpt_unseq_value_right"] },
  { ctor := `CerberusHeapLang.Frag.unseq,
  ...
  { ctor := `CerberusHeapLang.Frag.neg_store,
    ...
    also := [N "wps_neg_bound", N "wpt_neg_bound", N "wpt_neg_bound_compare",
      N "wps_bound_wseq_tuple", N "wpt_bound_wseq_tuple"] },
  { ctor := `CerberusHeapLang.Frag.neg_store_op,
    ...
    cls := .rule (N "wps_neg_round") (N "wpt_neg_round"),
    also := [N "wps_neg_bound", N "wpt_neg_bound", N "wpt_neg_bound_compare",
      N "EmittedIntSupport.wpt_intAssign"] },
  { ctor := `CerberusHeapLang.Frag.neg_store,
