...
`docs/2026-09-03_repin-fuel-signatures-pre.txt` (deduplicated 2026-09-03 as
byte-identical to `2026-09-03_k5-signatures-post.txt`, which is the kept
copy; identity re-verified by md5 in the standards audit) is a copy of
