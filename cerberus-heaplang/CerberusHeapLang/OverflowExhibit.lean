...
theorem overflow_evalClass {tds : CerbTags.TagDefsMap} {ext : Fmap sym sym}
...
theorem overflow_step_ctx (tds : Fmap sym (CerbLocation.Loc × tag_definition)) (σ : Mem)
...
theorem overflow_driver2_killed (fl : Nat) (dst : driver_state) (th : thread_state)
  ...
  obtain ⟨s, m, hsteps, hm⟩ := overflow_step_ctx fmapEmpty dst.layout_state dst.core_file
    dst.core_extern 0 none th harena hb1 hb2
  obtain ⟨dstK, hloop⟩ := loop_step_withrs_eval_killed 99999999 fmapEmpty fmapEmpty hth hsteps (hm _)
  exact ⟨dstK, driver2_killed fl fmapEmpty dst dstK th _ hth hloop⟩
...
theorem symK_eval {tds : CerbTags.TagDefsMap} {file : generic_file Unit core_run_annotation}
...
theorem overflow_driver2_killed_frame (fl : Nat) (dst : driver_state) (th : thread_state)
  ...
  overflow_driver2_killed fl dst th hth harena
