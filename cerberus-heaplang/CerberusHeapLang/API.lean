...
| The allocator cursor | `AllocCursor` (as a resource), `advanceCursor`, `freshBase`, `cursorOwn`, `wps_create_cursor_internal`, `wpt_create_cursor_internal`, `CohG.create`, `allocateObject_success` (Heap, Wps, Wpt) | `allocCap` is the abstract capacity face; the cursor is how the heap implements it |
