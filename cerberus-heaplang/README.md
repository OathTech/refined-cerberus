...
| Emitted-Core coverage now includes t1, t5 and t6: complete fragment witnesses and shipped-driver theorems. t5 adds expression-case evaluation and negative assignment with an explicit fresh-symbol floor; Ecase components under unseq are supported when ccall-free. t4 has whole-term membership, checked label continuations and a total proof of its short-circuit condition; its loop proof and production result remain pending, as do C calls, scheduler forks and the remaining E6/E7 cases. Strong symbol binding supports bare and annotated heads; the annotated-tuple binder is ruled. | Remaining dialect work and the architecture review (`../docs/2026-09-04_emitted-core-dialect-design.md`, `docs/2026-09-05_e5-resume.md`) | Scope above; claim matrix C14–C16; generated capability manifest |
